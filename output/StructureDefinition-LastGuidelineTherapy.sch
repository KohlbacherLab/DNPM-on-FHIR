...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile GuidelineTherapy
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      <sch:assert test="count(f:extension[@url = 'https://github.com/KohlbacherLab/DNPM-on-FHIR/StructureDefinition/TherapyLine']) &lt;= 1">extension with URL = 'https://github.com/KohlbacherLab/DNPM-on-FHIR/StructureDefinition/TherapyLine': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
